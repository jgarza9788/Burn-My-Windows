...
void main() {
  ...
  if (uRandomColor)
  {
    ...
    vec4 c0 = vec4(baseColor0,uGradient1.a);
    vec4 c1 = vec4(baseColor0,uGradient2.a);
    vec4 c2 = vec4(baseColor1,uGradient3.a);
    vec4 c3 = vec4(baseColor1,uGradient4.a);
    vec4 c4 = vec4(baseColor2,uGradient5.a);
