...
export default class Effect {
  ...
  constructor() {
    this.shaderFactory = new ShaderFactory(Effect.getNick(),
                                           (shader) => {
  ...
  // named likes this.
  static getNick() {
    return 'eightbit-plumber';
  }

  // This will be shown in the sidebar of the preferences dialog as well as in the
  // drop-down menus where the user can choose the effect.
  static getLabel() {
    return _('EightBit Plumber');
  }
  ...
  static bindPreferences(dialog) {
    ...
    dialog.bindAdjustment('eightbit-plumber-animation-time');
  }
